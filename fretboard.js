...
class Fretboard {
    ...
    drawNoteMarker(x, y, color, text) {
        ...
        switch (this.settings.noteShape) {
            ...
            case 'heart':
                ...
                const heartScale = size / 10;
                const heartD = `M ${x} ${y+6*heartScale} C ${x} ${y+4*heartScale} ${x-10*heartScale} ${y-2*heartScale} ${x-10*heartScale} ${y-2*heartScale} C ${x-10*heartScale} ${y-6*heartScale} ${x-6*heartScale} ${y-10*heartScale} ${x} ${y-4*heartScale} C ${x+6*heartScale} ${y-10*heartScale} ${x+10*heartScale} ${y-6*heartScale} ${x+10*heartScale} ${y-2*heartScale} C ${x+10*heartScale} ${y-2*heartScale} ${x} ${y+4*heartScale} ${x} ${y+6*heartScale} Z`;
                heartPath.setAttribute('d', heartD);
                return heartPath;
                
            case 'cross':
                marker = document.createElementNS('http://www.w3.org/2000/svg', 'path');
                marker.setAttribute('d', `M ${x-size} ${y} H ${x+size} M ${x} ${y-size} V ${y+size}`);
                marker.setAttribute('stroke', fillValue);
                marker.setAttribute('stroke-width', size/2);
            ...
            case 'plus':
                ...
                marker.setAttribute('d', `M ${x-size} ${y} H ${x+size} M ${x} ${y-size} V ${y+size}`);
                marker.setAttribute('stroke', fillValue);
                marker.setAttribute('stroke-width', size/3);
                marker.setAttribute('fill', 'none');
                break;
            ...
            case 'arrow':
                marker = document.createElementNS('http://www.w3.org/2000/svg', 'polygon');
                marker.setAttribute('points', 
                    `${x},${y-size} ${x+size*0.7},${y+size*0.3} ${x},${y+size*0.5} ${x-size*0.7},${y+size*0.3}`);
                break;
                
            case 'teardrop':
                marker = document.createElementNS('http://www.w3.org/2000/svg', 'path');
                marker.setAttribute('d', `M ${x} ${y-size} C ${x+size} ${y-size/2} ${x+size} ${y+size/2} ${x} ${y+size} C ${x-size} ${y+size/2} ${x-size} ${y-size/2} ${x} ${y-size} Z`);
                break;
            ...
            case 'oval':
                ...
                marker.setAttribute('cx', x);
                marker.setAttribute('cy', y);
                marker.setAttribute('rx', size*1.3);
                marker.setAttribute('ry', size*0.8);
                break;
                
            case 'rectangle':
                marker = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
                marker.setAttribute('x', x - size*1.3);
                marker.setAttribute('y', y - size*0.7);
                marker.setAttribute('width', size * 2.6);
                marker.setAttribute('height', size * 1.4);
                break;
                
            case 'rhombus':
                marker = document.createElementNS('http://www.w3.org/2000/svg', 'polygon');
                marker.setAttribute('points', 
                    `${x},${y-size*1.2} ${x+size*0.8},${y} ${x},${y+size*1.2} ${x-size*0.8},${y}`);
                break;
            ...
            case 'crosshair':
                ...
                lines.setAttribute('stroke', this.getContrastColor(color));
        ...
        if (marker) {
            ...
            switch (this.settings.noteEffect) {
                ...
                case 'ripple':
                    ...
                    ripple.setAttribute('r', size);
                    ripple.setAttribute('fill', 'none');
                    ripple.setAttribute('stroke', color);
                    ripple.setAttribute('stroke-width', '1');
                    
                    const rippleAnim1 = document.createElementNS('http://www.w3.org/2000/svg', 'animate');
                    rippleAnim1.setAttribute('attributeName', 'r');
                    rippleAnim1.setAttribute('values', `${size};${size * 2.5}`);
                    rippleAnim1.setAttribute('dur', '1.5s');
                    rippleAnim1.setAttribute('repeatCount', 'indefinite');
                    
                    const rippleAnim2 = document.createElementNS('http://www.w3.org/2000/svg', 'animate');
                    rippleAnim2.setAttribute('attributeName', 'opacity');
                    rippleAnim2.setAttribute('values', '0.6;0');
                    rippleAnim2.setAttribute('dur', '1.5s');
                    rippleAnim2.setAttribute('repeatCount', 'indefinite');
                    
                    ripple.appendChild(rippleAnim1);
                    ripple.appendChild(rippleAnim2);
                    markerGroup.appendChild(ripple);
                    break;

                case 'wave':
                    const waveFilter = document.createElementNS('http://www.w3.org/2000/svg', 'filter');
                    const waveId = `wave-${Math.random().toString(36).substring(2, 9)}`;
                    waveFilter.setAttribute('id', waveId);
                    ...
                    feTurbulence.setAttribute('seed', Math.random() * 100);
                    ...
                    const waveAnim = document.createElementNS('http://www.w3.org/2000/svg', 'animate');
                    waveAnim.setAttribute('attributeName', 'baseFrequency');
                    waveAnim.setAttribute('values', '0.05;0.07;0.05');
                    waveAnim.setAttribute('dur', '2s');
                    waveAnim.setAttribute('repeatCount', 'indefinite');
                    
                    feTurbulence.appendChild(waveAnim);
                    waveFilter.appendChild(feTurbulence);
                    waveFilter.appendChild(feDisplacementMap);
                    
                    const waveDefs = this.svg.querySelector('defs') || 
                                   this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                    waveDefs.appendChild(waveFilter);
                    
                    marker.setAttribute('filter', `url(#${waveId})`);
                    break;
                    
                case 'neon':
                    const neonFilter = document.createElementNS('http://www.w3.org/2000/svg', 'filter');
                    const neonId = `neon-${Math.random().toString(36).substring(2, 9)}`;
                    neonFilter.setAttribute('id', neonId);
                    ...
                    feGaussianBlur2.setAttribute('in', 'mask');
                    ...
                    neonFilter.appendChild(feFlood);
                    neonFilter.appendChild(feComposite);
                    neonFilter.appendChild(feGaussianBlur2);
                    neonFilter.appendChild(feMerge);
                    
                    const neonDefs = this.svg.querySelector('defs') || 
                                   this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                    neonDefs.appendChild(neonFilter);
                    
                    marker.setAttribute('filter', `url(#${neonId})`);
                    marker.setAttribute('stroke-width', '2');
                    break;

                    // Additional effects implementations could go here
                    // For the remaining effects, I've added placeholders that show as text within the notes
                    // In a complete implementation, each would have similar SVG filter/animation code
            ...
            if (this.settings.displayMode !== 'none') {
                ...
                textElement.setAttribute('fill', this.getContrastColor(color));
    ...
    applyFretStyle(fretElement, style, themeColors) {
        switch (style) {
            ...
            case 'brushed':
                fretElement.setAttribute('stroke', '#B8B8B8');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.1);
                const brushedFilter = document.createElementNS('http://www.w3.org/2000/svg', 'filter');
                const brushedId = `brushed-${Math.random().toString(36).substring(2, 9)}`;
                brushedFilter.setAttribute('id', brushedId);
                
                const brushedTurbulence = document.createElementNS('http://www.w3.org/2000/svg', 'feTurbulence');
                brushedTurbulence.setAttribute('type', 'fractalNoise');
                brushedTurbulence.setAttribute('baseFrequency', '0.08');
                brushedTurbulence.setAttribute('numOctaves', '3');
                brushedTurbulence.setAttribute('seed', '2');
                brushedTurbulence.setAttribute('stitchTiles', 'stitch');
                
                const brushedDisplacementMap = document.createElementNS('http://www.w3.org/2000/svg', 'feDisplacementMap');
                brushedDisplacementMap.setAttribute('in', 'SourceGraphic');
                brushedDisplacementMap.setAttribute('in2', 'turbulence');
                brushedDisplacementMap.setAttribute('scale', '1');
                brushedDisplacementMap.setAttribute('xChannelSelector', 'R');
                brushedDisplacementMap.setAttribute('yChannelSelector', 'G');
                
                brushedFilter.appendChild(brushedTurbulence);
                brushedFilter.appendChild(brushedDisplacementMap);
                
                const defs = this.svg.querySelector('defs') || 
                            this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                defs.appendChild(brushedFilter);
                
                fretElement.setAttribute('filter', `url(#${brushedId})`);
                break;
                
            case 'matte':
                fretElement.setAttribute('stroke', '#707070');
                fretElement.setAttribute('stroke-opacity', '0.9');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.2);
                break;
                
            case 'satin':
                fretElement.setAttribute('stroke', '#D0D0D0');
                const satinGradientId = `satin-gradient-${Math.random().toString(36).substring(2, 9)}`;
                const satinGradient = document.createElementNS('http://www.w3.org/2000/svg', 'linearGradient');
                satinGradient.setAttribute('id', satinGradientId);
                
                const satinStop1 = document.createElementNS('http://www.w3.org/2000/svg', 'stop');
                satinStop1.setAttribute('offset', '0%');
                satinStop1.setAttribute('stop-color', '#D0D0D0');
                
                const satinStop2 = document.createElementNS('http://www.w3.org/2000/svg', 'stop');
                satinStop2.setAttribute('offset', '50%');
                satinStop2.setAttribute('stop-color', '#A0A0A0');
                
                const satinStop3 = document.createElementNS('http://www.w3.org/2000/svg', 'stop');
                satinStop3.setAttribute('offset', '100%');
                satinStop3.setAttribute('stop-color', '#D0D0D0');
                
                satinGradient.appendChild(satinStop1);
                satinGradient.appendChild(satinStop2);
                satinGradient.appendChild(satinStop3);
                
                const satinDefs = this.svg.querySelector('defs') || 
                            this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                satinDefs.appendChild(satinGradient);
                
                fretElement.setAttribute('stroke', `url(#${satinGradientId})`);
                break;
                
            case 'weathered':
                fretElement.setAttribute('stroke', '#8C7853');
                fretElement.setAttribute('stroke-dasharray', '1,0.2');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 0.9);
                fretElement.setAttribute('stroke-opacity', '0.85');
                break;
                
            case 'stainless':
                fretElement.setAttribute('stroke', '#E8E8E8');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.2);
                this.applyMetallicEffectToFret(fretElement, '#E8E8E8');
                break;
                
            case 'tinted':
                const tintColor = '#9370DB'; // Purple tint
                fretElement.setAttribute('stroke', tintColor);
                fretElement.setAttribute('stroke-opacity', '0.7');
                break;
                
            case 'ebony':
                fretElement.setAttribute('stroke', '#393939');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.2);
                break;
                
            case 'rosewood':
                fretElement.setAttribute('stroke', '#623B2A');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.1);
                break;
                
            case 'maple':
                fretElement.setAttribute('stroke', '#E8C59C');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.1);
                break;
                
            case 'ceramic':
                fretElement.setAttribute('stroke', '#FFFFFF');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.3);
                fretElement.setAttribute('stroke-opacity', '0.9');
                break;
                
            case 'carbon-fiber':
                fretElement.setAttribute('stroke', '#2F2F2F');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.1);
                
                const carbonFilter = document.createElementNS('http://www.w3.org/2000/svg', 'filter');
                const carbonId = `carbon-${Math.random().toString(36).substring(2, 9)}`;
                carbonFilter.setAttribute('id', carbonId);
                
                const carbonPattern = document.createElementNS('http://www.w3.org/2000/svg', 'feTurbulence');
                carbonPattern.setAttribute('baseFrequency', '0.2');
                carbonPattern.setAttribute('numOctaves', '2');
                carbonPattern.setAttribute('stitchTiles', 'stitch');
                
                carbonFilter.appendChild(carbonPattern);
                
                const carbonDefs = this.svg.querySelector('defs') || 
                          this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                carbonDefs.appendChild(carbonFilter);
                
                fretElement.setAttribute('filter', `url(#${carbonId})`);
                break;
                
            case 'luminous':
                fretElement.setAttribute('stroke', '#C0FFEE');
                this.applyGlowEffect(fretElement, '#C0FFEE');
                break;
                
            case 'zebra':
                const zebraPattern = document.createElementNS('http://www.w3.org/2000/svg', 'pattern');
                const zebraId = `zebra-${Math.random().toString(36).substring(2, 9)}`;
                zebraPattern.setAttribute('id', zebraId);
                zebraPattern.setAttribute('width', '4');
                zebraPattern.setAttribute('height', '4');
                zebraPattern.setAttribute('patternUnits', 'userSpaceOnUse');
                zebraPattern.setAttribute('patternTransform', 'rotate(90)');
                
                const zebraRect1 = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
                zebraRect1.setAttribute('width', '2');
                zebraRect1.setAttribute('height', '4');
                zebraRect1.setAttribute('fill', '#000000');
                
                const zebraRect2 = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
                zebraRect2.setAttribute('x', '2');
                zebraRect2.setAttribute('width', '2');
                zebraRect2.setAttribute('height', '4');
                zebraRect2.setAttribute('fill', '#FFFFFF');
                
                zebraPattern.appendChild(zebraRect1);
                zebraPattern.appendChild(zebraRect2);
                
                const zebraDefs = this.svg.querySelector('defs') || 
                          this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                zebraDefs.appendChild(zebraPattern);
                
                fretElement.setAttribute('stroke', `url(#${zebraId})`);
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 2.5);
                break;
                
            case 'tiger':
                fretElement.setAttribute('stroke', '#FFA500');
                fretElement.setAttribute('stroke-dasharray', '3,1,1,1');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.2);
                break;
                
            case 'checkered':
                const checkeredPattern = document.createElementNS('http://www.w3.org/2000/svg', 'pattern');
                const checkeredId = `checkered-${Math.random().toString(36).substring(2, 9)}`;
                checkeredPattern.setAttribute('id', checkeredId);
                checkeredPattern.setAttribute('width', '6');
                checkeredPattern.setAttribute('height', '6');
                checkeredPattern.setAttribute('patternUnits', 'userSpaceOnUse');
                
                const checkeredRect1 = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
                checkeredRect1.setAttribute('width', '3');
                checkeredRect1.setAttribute('height', '3');
                checkeredRect1.setAttribute('fill', '#000000');
                
                const checkeredRect2 = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
                checkeredRect2.setAttribute('x', '3');
                checkeredRect2.setAttribute('width', '3');
                checkeredRect2.setAttribute('height', '3');
                checkeredRect2.setAttribute('fill', '#FFFFFF');
                
                const checkeredRect3 = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
                checkeredRect3.setAttribute('y', '3');
                checkeredRect3.setAttribute('width', '3');
                checkeredRect3.setAttribute('height', '3');
                checkeredRect3.setAttribute('fill', '#FFFFFF');
                
                const checkeredRect4 = document.createElementNS('http://www.w3.org/2000/svg', 'rect');
                checkeredRect4.setAttribute('x', '3');
                checkeredRect4.setAttribute('y', '3');
                checkeredRect4.setAttribute('width', '3');
                checkeredRect4.setAttribute('height', '3');
                checkeredRect4.setAttribute('fill', '#000000');
                
                checkeredPattern.appendChild(checkeredRect1);
                checkeredPattern.appendChild(checkeredRect2);
                checkeredPattern.appendChild(checkeredRect3);
                checkeredPattern.appendChild(checkeredRect4);
                
                const checkeredDefs = this.svg.querySelector('defs') || 
                          this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                checkeredDefs.appendChild(checkeredPattern);
                
                fretElement.setAttribute('stroke', `url(#${checkeredId})`);
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 2.5);
                break;
                
            case 'marbled':
                const marbledFilter = document.createElementNS('http://www.w3.org/2000/svg', 'filter');
                const marbledId = `marbled-${Math.random().toString(36).substring(2, 9)}`;
                marbledFilter.setAttribute('id', marbledId);
                
                const marbledTurbulence = document.createElementNS('http://www.w3.org/2000/svg', 'feTurbulence');
                marbledTurbulence.setAttribute('type', 'turbulence');
                marbledTurbulence.setAttribute('baseFrequency', '0.05');
                marbledTurbulence.setAttribute('numOctaves', '2');
                marbledTurbulence.setAttribute('seed', '3');
                marbledTurbulence.setAttribute('stitchTiles', 'stitch');
                
                marbledFilter.appendChild(marbledTurbulence);
                
                const marbledDefs = this.svg.querySelector('defs') || 
                          this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                marbledDefs.appendChild(marbledFilter);
                
                fretElement.setAttribute('stroke', '#E0E0E0');
                fretElement.setAttribute('filter', `url(#${marbledId})`);
                break;
                
            case 'iridescent':
                const iridGradientId = `irid-gradient-${Math.random().toString(36).substring(2, 9)}`;
                const iridGradient = document.createElementNS('http://www.w3.org/2000/svg', 'linearGradient');
                iridGradient.setAttribute('id', iridGradientId);
                
                const iridColors = ['#FF1493', '#9932CC', '#4169E1', '#2E8B57', '#FFD700'];
                iridColors.forEach((color, i) => {
                    const stop = document.createElementNS('http://www.w3.org/2000/svg', 'stop');
                    stop.setAttribute('offset', `${i * 100 / (iridColors.length - 1)}%`);
                    stop.setAttribute('stop-color', color);
                    iridGradient.appendChild(stop);
                });
                
                const iridDefs = this.svg.querySelector('defs') || 
                          this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                iridDefs.appendChild(iridGradient);
                
                fretElement.setAttribute('stroke', `url(#${iridGradientId})`);
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.3);
                break;
                
            case 'engraved':
                fretElement.setAttribute('stroke', '#595959');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 0.8);
                
                const engraveShadow = fretElement.cloneNode(true);
                engraveShadow.setAttribute('x1', parseFloat(fretElement.getAttribute('x1')) - 0.5);
                engraveShadow.setAttribute('x2', parseFloat(fretElement.getAttribute('x2')) - 0.5);
                engraveShadow.setAttribute('stroke', '#FFFFFF');
                engraveShadow.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 0.4);
                engraveShadow.setAttribute('stroke-opacity', '0.7');
                
                this.svg.appendChild(engraveShadow);
                break;
                
            case 'distressed':
                fretElement.setAttribute('stroke', '#886D4F');
                fretElement.setAttribute('stroke-dasharray', '5,0.5,1,0.5');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 0.9);
                fretElement.setAttribute('stroke-opacity', '0.85');
                break;
                
            case 'textured':
                fretElement.setAttribute('stroke', '#A9A9A9');
                fretElement.setAttribute('stroke-width', parseInt(fretElement.getAttribute('stroke-width')) * 1.1);
                
                const textureFilter = document.createElementNS('http://www.w3.org/2000/svg', 'filter');
                const textureId = `texture-${Math.random().toString(36).substring(2, 9)}`;
                textureFilter.setAttribute('id', textureId);
                
                const textureTurbulence = document.createElementNS('http://www.w3.org/2000/svg', 'feTurbulence');
                textureTurbulence.setAttribute('type', 'fractalNoise');
                textureTurbulence.setAttribute('baseFrequency', '0.7');
                textureTurbulence.setAttribute('numOctaves', '3');
                textureTurbulence.setAttribute('stitchTiles', 'stitch');
                
                const textureDisplacementMap = document.createElementNS('http://www.w3.org/2000/svg', 'feDisplacementMap');
                textureDisplacementMap.setAttribute('in', 'SourceGraphic');
                textureDisplacementMap.setAttribute('in2', 'turbulence');
                textureDisplacementMap.setAttribute('scale', '1.5');
                textureDisplacementMap.setAttribute('xChannelSelector', 'R');
                textureDisplacementMap.setAttribute('yChannelSelector', 'G');
                
                textureFilter.appendChild(textureTurbulence);
                textureFilter.appendChild(textureDisplacementMap);
                
                const textureDefs = this.svg.querySelector('defs') || 
                          this.svg.insertBefore(document.createElementNS('http://www.w3.org/2000/svg', 'defs'), this.svg.firstChild);
                textureDefs.appendChild(textureFilter);
                
                fretElement.setAttribute('filter', `url(#${textureId})`);
                break;
        }
    }
