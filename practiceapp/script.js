...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add event listener for note display type change
    if (noteDisplayType) {
        noteDisplayType.addEventListener('change', updateNoteDisplay);
    }
    ...
    const SLIDESHOWS = {
        ...
        'la-folia': [
            ...
            { key: 'A', type: 'chord', name: 'dom7', title: 'A Dominant 7th', description: 'V7 - Dominant.' },
            { key: 'D', type: 'chord', name: 'minor-triad', title: 'D Minor', description: 'i - Tonic minor.' },
        ...
        'montgomery-ward': [
            { key: 'C', type: 'chord', name: 'major-triad', title: 'C Major', description: 'The I chord. The tonic.' },
            { key: 'E', type: 'chord', name: 'dom7', title: 'E Dominant 7', description: 'The V chord of the key.' },
            { key: 'A', type: 'chord', name: 'min7', title: 'A Minor 7', description: 'The vi chord, the relative minor.' },
            { key: 'D', type: 'chord', name: 'min7', title: 'D Minor 7', description: 'The ii chord, supertonic.' },
            { key: 'G', type: 'chord', name: 'dom7', title: 'G7', description: 'The dominant (V).' },
            { key: 'C', type: 'chord', name: 'major-triad', title: 'C Major', description: 'Resolution back to the tonic (I).' }
        ],
        'ragtime-progression': [
            { key: 'C', type: 'chord', name: 'maj7', title: 'Cmaj7', description: 'The I chord. The tonic.' },
            { key: 'A', type: 'chord', name: 'dom7', title: 'Am7', description: 'The vi chord, leading to ii.' },
            { key: 'D', type: 'chord', name: 'dom7', title: 'D7', description: 'The II chord, leading to V.' },
            { key: 'G', type: 'chord', name: 'dom7', title: 'G7', description: 'The dominant, resolving to I.' }
        ],
        'flamenco-progression': [
            ...
            { key: 'A', type: 'chord', name: 'dom7', title: 'A7', description: 'The V chord. Target the chord tones.' }
        ],
        'cry-me-a-river': [
            ...
            { key: 'G', type: 'chord', name: 'dom7', title: 'G7', description: 'The subtonic dominant.' },
            { key: 'C', type: 'chord', name: 'maj7', title: 'Cmaj7', description: 'The relative major.' }
        ],
        'a-day-in-the-life': [
            { key: 'G', type: 'chord', name: 'major-triad', title: 'G Major', description: 'The I chord. The tonic.' },
            { key: 'B', type: 'chord', name: 'minor-triad', title: 'B Minor', description: 'The iii chord, the mediant minor.' },
            { key: 'C', type: 'chord', name: 'major-triad', title: 'C Major', description: 'The IV chord. Cheerful and uplifting.' },
            { key: 'G', type: 'chord', name: 'major-triad', title: 'G Major', description: 'The I chord, returning to the tonic.' }
        ],
        ...
        'take-five': [
            ...
            { key: 'E', type: 'chord', name: 'dorian', title: 'E Dorian', description: 'Cool and sophisticated minor for funk.' },
            { key: 'A', type: 'chord', name: 'dom7', title: 'A7', description: 'The IV chord. A Mixolydian works well.' },
            { key: 'A', type: 'chord', name: 'mixolydian', title: 'A Mixolydian', description: 'Adds a bluesy feel to the IV chord.' },
            { key: 'E', type: 'chord', name: 'pentatonic-minor', title: 'E Minor Pentatonic', description: 'You can always fall back on the pentatonic.' }
        ],
        ...
        'blues-journey': [
            { key: 'E', type: 'chord', name: 'pentatonic-minor', title: 'Minor Pentatonic', description: 'The foundation of blues soloing.' },
            { key: 'E', type: 'chord', name: 'blues', title: 'Blues Scale', description: 'Adds the "blue note" (b5) for more flavor.' },
            { key: 'E', type: 'chord', name: 'pentatonic-major', title: 'Major Pentatonic', description: 'A sweeter, more melodic sound for a major blues.' },
            { key: 'E', type: 'chord', name: 'mixolydian', title: 'Mixolydian Mode', description: 'Outlines the dominant 7th sound of a blues I chord.' },
            { key: 'E', type: 'chord', name: 'dorian', title: 'Dorian Mode', description: 'A jazzy, sophisticated sound for a minor blues.' }
        ],
        'classical-modes': [
            { key: 'C', type: 'chord', name: 'ionian', title: 'Ionian (Major)', description: '1st mode: Bright and happy. The standard major scale.' },
            { key: 'D', type: 'chord', name: 'dorian', title: 'Dorian', description: '2nd mode: Minor with a raised 6th. Jazzy and cool.' },
            { key: 'E', type: 'chord', name: 'phrygian', title: 'Phrygian', description: '3rd mode: Minor with a lowered 2nd. Dark and Spanish-sounding.' },
            { key: 'F', type: 'chord', name: 'lydian', title: 'Lydian', description: '4th mode: Major with a raised 4th. Dreamy and magical.' },
            { key: 'G', type: 'chord', name: 'mixolydian', title: 'Mixolydian', description: '5th mode: Major with a lowered 7th. Bluesy and dominant.' },
            { key: 'A', type: 'chord', name: 'aeolian', title: 'Aeolian (Natural Minor)', description: '6th mode: The standard natural minor scale.' },
            { key: 'B', type: 'chord', name: 'locrian', title: 'Locrian', description: '7th mode: Minor with a lowered 2nd and 5th. Tense and unstable.' }
        ],
        'rock-pop': [
            { key: 'C', type: 'chord', name: 'major', title: 'Major Scale', description: 'The foundation for most pop melodies.' },
            { key: 'A', type: 'chord', name: 'minor', title: 'Natural Minor Scale', description: 'For sadder or more dramatic songs.' },
            { key: 'C', type: 'chord', name: 'pentatonic-major', title: 'Major Pentatonic', description: 'A simple, foolproof scale for happy solos.' },
            { key: 'A', type: 'chord', name: 'pentatonic-minor', title: 'Minor Pentatonic', description: 'The workhorse of rock guitar solos.' },
            { key: 'A', type: 'chord', name: 'blues', title: 'Blues Scale', description: 'Adds a gritty, soulful edge to rock and pop.' }
        ],
        'latin-rhythms': [
            { key: 'G', type: 'chord', name: 'mixolydian', title: 'Mixolydian', description: 'Common in Salsa and Latin Rock.' },
            { key: 'D', type: 'chord', name: 'dorian', title: 'Dorian', description: 'Used in Bossa Nova and Latin Jazz.' },
            { key: 'E', type: 'chord', name: 'phrygian-dominant', title: 'Phrygian Dominant', description: 'The characteristic sound of Flamenco and Latin music.' },
            { key: 'C', type: 'chord', name: 'major', title: 'Major Scale', description: 'The basis for many cheerful Latin pop tunes.' },
            { key: 'A', type: 'chord', name: 'minor', title: 'Natural Minor', description: 'For dramatic tangos and boleros.' }
        ],
        'celtic-scales': [
            { key: 'G', type: 'chord', name: 'mixolydian', title: 'Mixolydian', description: 'Very common in Irish and Scottish folk tunes.' },
            { key: 'D', type: 'chord', name: 'dorian', title: 'Dorian', description: 'Another staple of Celtic music, giving a melancholic feel.' },
            { key: 'C', type: 'chord', name: 'ionian', title: 'Ionian (Major)', description: 'Used for upbeat jigs and reels.' },
            { key: 'G', type: 'chord', name: 'pentatonic-major', title: 'Major Pentatonic', description: 'A simple 5-note scale found in many folk traditions.' },
            { key: 'E', type: 'chord', name: 'aeolian', title: 'Aeolian (Minor)', description: 'For sad airs and laments.' }
        ],
        'eastern-scales': [
            { key: 'C', type: 'chord', name: 'hirajoshi', title: 'Hirajoshi (Japanese)', description: 'An exotic Japanese pentatonic scale.' },
            { key: 'C', type: 'chord', name: 'byzantine', title: 'Byzantine (Double Harmonic)', description: 'A scale with two augmented seconds, giving a strong Middle Eastern feel.' },
            { key: 'C', type: 'chord', name: 'persian', title: 'Persian Scale', description: 'Another dramatic and exotic Middle Eastern scale.' },
            { key: 'C', type: 'chord', name: 'chinese-pentatonic', title: 'Chinese Pentatonic', description: 'The same as the major pentatonic, central to Chinese music.' },
            { key: 'C', type: 'chord', name: 'indian-raga-bhairav', title: 'Indian Raga (Bhairav)', description: 'A morning raga with a distinct mood.' }
        ],
        'modern-jazz': [
            { key: 'G', type: 'chord', name: 'altered', title: 'Altered Scale (Super Locrian)', description: 'Creates maximum tension over a V7 chord.' },
            { key: 'F', type: 'chord', name: 'lydian-dominant', title: 'Lydian Dominant', description: 'A bright, modern sound for a non-resolving dominant chord.' },
            { key: 'C', type: 'chord', name: 'whole-tone', title: 'Whole Tone Scale', description: 'A six-note scale with a dreamy, ambiguous sound.' },
            { key: 'C', type: 'chord', name: 'diminished', title: 'Diminished (W-H)', description: 'A symmetrical scale perfect for navigating diminished chords.' },
            { key: 'C', type: 'chord', name: 'melodic-minor', title: 'Melodic Minor', description: 'The "jazz minor," a key source for modern harmony and improvisation.' }
        ],
        'folk-traditions': [
            { key: 'C', type: 'chord', name: 'major', title: 'Major (Ionian)', description: 'The basis for many Western folk songs.' },
            { key: 'G', type: 'chord', name: 'mixolydian', title: 'Mixolydian', description: 'Common in Appalachian and British folk music.' },
            { key: 'D', type: 'chord', name: 'dorian', title: 'Dorian', description: 'Found in Irish, Scottish, and English folk.' },
            { key: 'A', type: 'chord', name: 'minor', title: 'Natural Minor (Aeolian)', description: 'For melancholic folk ballads.' },
            { key: 'C', type: 'chord', name: 'pentatonic-major', title: 'Major Pentatonic', description: 'A universal scale in folk music worldwide.' }
        ],
        'bebop-essentials': [
            { key: 'C', type: 'chord', name: 'bebop-major', title: 'Bebop Major', description: 'A major scale with a passing tone for smooth 8th-note lines.' },
            { key: 'G', type: 'chord', name: 'bebop-minor', title: 'Bebop Minor', description: 'Adds a passing tone to the dorian mode.' }
        ],
        'fusion-elements': [
            { key: 'D', type: 'chord', name: 'dorian', title: 'Dorian', description: 'A staple mode for fusion improvisation.' },
            { key: 'G', type: 'chord', name: 'mixolydian', title: 'Mixolydian', description: 'For dominant chord vamps with a rock edge.' },
            { key: 'F', type: 'chord', name: 'lydian-dominant', title: 'Lydian Dominant', description: 'A modern, bright sound over dominant chords.' },
            { key: 'C', type: 'chord', name: 'pentatonic-minor', title: 'Minor Pentatonic', description: 'Often used with wider intervals and chromatic passing tones.' },
            { key: 'C', type: 'chord', name: 'whole-tone', title: 'Whole Tone', description: 'For creating floating, outside-the-box textures.' }
        ],
        'gospel-soul': [
            { key: 'C', type: 'chord', name: 'major', title: 'Major Scale', description: 'The foundation for gospel harmony.' },
            { key: 'C', type: 'chord', name: 'pentatonic-major', title: 'Major Pentatonic', description: 'For soulful vocal melodies and instrumental fills.' },
            { key: 'A', type: 'chord', name: 'blues', title: 'Blues Scale', description: 'Adds the essential "blue note" grit and emotion.' },
            { key: 'G', type: 'chord', name: 'mixolydian', title: 'Mixolydian', description: 'Used over the V chord for that classic gospel turnaround.' },
            { key: 'D', type: 'chord', name: 'dorian', title: 'Dorian', description: 'A common sound for the ii chord in gospel progressions.' }
        ],
        'country-western': [
            { key: 'G', type: 'chord', name: 'major', title: 'Major (Ionian)', description: 'The basis for most classic country songs.' },
            { key: 'G', type: 'chord', name: 'pentatonic-major', title: 'Major Pentatonic', description: 'The primary scale for country guitar licks.' },
            { key: 'G', type: 'chord', name: 'blues', title: 'G Blues Scale', description: 'Add the b3 for a bluesy country feel.' },
            { key: 'E', type: 'chord', name: 'dom7', title: 'E7', description: 'The V chord. Target the chord tones.' },
            { key: 'E', type: 'chord', name: 'mixolydian', title: 'E Mixolydian', description: 'The perfect scale to outline the V7 sound.' }
        ],
        'mediterranean': [
            { key: 'E', type: 'chord', name: 'phrygian-dominant', title: 'Phrygian Dominant', description: 'The quintessential Spanish and Flamenco sound.' },
            { key: 'C', type: 'chord', name: 'double-harmonic-major', title: 'Double Harmonic Major', description: 'Also known as the Byzantine scale, with a strong Middle Eastern flavor.' },
            { key: 'A', type: 'chord', name: 'harmonic-minor', title: 'Harmonic Minor', description: 'Used in Greek and Eastern European folk music.' },
            { key: 'D', type: 'chord', name: 'dorian', title: 'Dorian', description: 'Common in Greek folk music.' }
        ],
        'pentatonic-world': [
            { key: 'C', type: 'chord', name: 'pentatonic-major', title: 'Major Pentatonic', description: 'Found in Western, African, and East Asian music.' },
            { key: 'A', type: 'chord', name: 'pentatonic-minor', title: 'Minor Pentatonic', description: 'The relative minor, equally widespread.' },
            { key: 'C', type: 'chord', name: 'hirajoshi', title: 'Hirajoshi', description: 'A Japanese pentatonic scale with a unique, evocative sound.' },
            { key: 'C', type: 'chord', name: 'egyptian', title: 'Egyptian', description: 'A suspended-sounding pentatonic scale.' },
            { key: 'F', type: 'chord', name: 'lydian-pentatonic', title: 'Lydian Pentatonic', description: 'A bright, open-sounding 5-note scale.' }
        ],
        'chromatic-journey': [
            { key: 'C', type: 'chord', name: 'major', title: 'Major Scale', description: 'Diatonic starting point (7 notes).' },
            { key: 'C', type: 'chord', name: 'bebop-major', title: 'Bebop Major', description: 'Adding one chromatic passing tone (8 notes).' },
            { key: 'C', type: 'chord', name: 'diminished', title: 'Diminished Scale', description: 'A symmetrical scale (8 notes).' },
            { key: 'C', type: 'chord', name: 'blues', title: 'Blues Scale', description: 'A hexatonic (6-note) scale with chromaticism.' },
            { key: 'C', type: 'chord', name: 'chromatic', title: 'Chromatic Scale', description: 'The destination: all 12 notes.' }
        ],
        'harmonic-minor-family': [
            { key: 'A', type: 'chord', name: 'harmonic-minor', title: 'Harmonic Minor', description: '1st mode: The parent scale. Minor with a major 7th.' },
            { key: 'B', type: 'chord', name: 'locrian-natural-6', title: 'Locrian Natural 6', description: '2nd mode: Dark and tense with a surprising major 6th.' },
            { key: 'C', type: 'chord', name: 'ionian-augmented', title: 'Ionian #5', description: '3rd mode: A major scale with a sharp 5th.' },
            { key: 'D', type: 'chord', name: 'ukrainian-dorian', title: 'Ukrainian Dorian', description: '4th mode: Dorian with a sharp 4th. A unique, folky sound.' },
            { key: 'E', type: 'chord', name: 'phrygian-dominant', title: 'Phrygian Dominant', description: '5th mode: The most popular mode. Spanish/metal flavor.' },
            { key: 'F', type: 'chord', name: 'lydian-sharp-2', title: 'Lydian #2', description: '6th mode: A bright Lydian sound with a sharp 2nd.' },
            { key: 'G', type: 'chord', name: 'super-locrian-bb7', title: 'Altered Dominant bb7', description: '7th mode: Extremely altered and tense.' }
        ],
        'melodic-minor-family': [
            { key: 'C', type: 'chord', name: 'melodic-minor', title: 'Melodic Minor (Jazz Minor)', description: '1st mode: Minor with a major 6th and 7th.' },
            { key: 'D', type: 'chord', name: 'dorian-b2', title: 'Dorian b2', description: '2nd mode: Dorian with a flat 2nd. A dark but smooth sound.' },
            { key: 'E', type: 'chord', name: 'lydian-augmented', title: 'Lydian Augmented', description: '3rd mode: Lydian with a sharp 5th. Very bright and spacey.' },
            { key: 'F', type: 'chord', name: 'lydian-dominant', title: 'Lydian Dominant', description: '4th mode: Mixolydian with a sharp 4th. A modern jazz staple.' },
            { key: 'G', type: 'chord', name: 'mixolydian-b6', title: 'Mixolydian b6', description: '5th mode: A dominant scale with a minor 6th. A darker dominant sound.' },
            { key: 'A', type: 'chord', name: 'locrian-natural-2', title: 'Half-Diminished', description: '6th mode: The perfect scale for min7(b5) chords.' },
            { key: 'B', type: 'chord', name: 'altered', title: 'Altered Scale (Super Locrian)', description: '7th mode: The ultimate tension scale for V7 chords.' }
        ],
        'diminished-concepts': [
            { key: 'C', type: 'chord', name: 'diminished', title: 'Diminished (W-H)', description: 'Starts with a whole step. Fits Cdim7 chords.' },
            { key: 'C', type: 'chord', name: 'half-whole-diminished', title: 'Diminished (H-W)', description: 'Starts with a half step. Fits C7(b9) chords.' },
        ...
        'whole-tone-world': [
            { key: 'C', type: 'chord', name: 'whole-tone', title: 'Whole Tone Scale', description: 'A 6-note scale of only whole steps. Dreamy and ambiguous.' },
            ...
            { key: 'D', type: 'chord', name: 'whole-tone', title: 'The "Other" Whole Tone Scale', description: 'There are only two unique whole tone scales. This is the other one.' }
        ],
        'blues-improvisation-toolkit': [
            ...
            { key: 'E', type: 'chord', name: 'blues', title: 'E Blues Scale', description: 'The classic choice over the entire progression.' },
            { key: 'A', type: 'chord', name: 'dom7', title: 'A7 (IV)', description: 'The IV chord. Use A Blues or A Mixolydian.' },
            { key: 'A', type: 'chord', name: 'mixolydian', title: 'A Mixolydian', description: 'Outlines the A7 chord tones perfectly.' },
            { key: 'B', type: 'chord', name: 'dom7', title: 'B7 (V)', description: 'The V chord. Use B Mixolydian or B Phrygian Dominant for tension.' },
            { key: 'B', type: 'chord', name: 'phrygian-dominant', title: 'B Phrygian Dominant', description: 'Adds a spicy, tense sound over the V chord.' }
        ],
        'modal-jazz-explorer': [
            { key: 'C', type: 'chord', name: 'maj7', title: 'Cmaj7 (Ionian)', description: 'The Ionian chord. Bright and stable.' },
            { key: 'C', type: 'chord', name: 'ionian', title: 'C Ionian Scale', description: 'The major scale, the first mode.' },
            { key: 'D', type: 'chord', name: 'min7', title: 'Dm7 (Dorian)', description: 'The Dorian chord. Cool, jazzy minor.' },
            { key: 'D', type: 'chord', name: 'dorian', title: 'D Dorian Scale', description: 'Minor scale with a major 6th.' },
            { key: 'E', type: 'chord', name: 'min7', title: 'Em7 (Phrygian)', description: 'The Phrygian chord. Dark, Spanish flavor.' },
            { key: 'E', type: 'chord', name: 'phrygian', title: 'E Phrygian Scale', description: 'Minor scale with a flat 2nd.' },
            { key: 'F', type: 'chord', name: 'maj7', title: 'Fmaj7#11 (Lydian)', description: 'The Lydian chord. Bright, dreamy, and magical.' },
            { key: 'F', type: 'chord', name: 'lydian', title: 'F Lydian Scale', description: 'Major scale with a raised 4th.' },
            { key: 'G', type: 'chord', name: 'dom7', title: 'G7 (Mixolydian)', description: 'The Mixolydian chord. Bluesy, dominant sound.' },
            { key: 'G', type: 'chord', name: 'mixolydian', title: 'G Mixolydian Scale', description: 'Major scale with a flat 7th.' },
            { key: 'A', type: 'chord', name: 'min7', title: 'Am7 (Aeolian)', description: 'The vi chord. Use A Aeolian.' },
            { key: 'A', type: 'chord', name: 'aeolian', title: 'A Aeolian Scale', description: 'The natural minor scale.' },
            { key: 'B', type: 'chord', name: 'half-dim7', title: 'Bm7b5 (Locrian)', description: 'The Locrian chord. Tense and unstable.' },
            { key: 'B', type: 'chord', name: 'locrian', title: 'B Locrian Scale', description: 'The darkest mode, with a flat 2 and flat 5.' }
        ],
        'rock-riffage': [
            { key: 'E', type: 'chord', name: 'perfect-5th', title: 'E5 Power Chord', description: 'The foundation of rock guitar.' },
            { key: 'E', type: 'chord', name: 'pentatonic-minor', title: 'E Minor Pentatonic', description: 'The go-to scale for rock solos.' },
            { key: 'A', type: 'chord', name: 'perfect-5th', title: 'A5 Power Chord', description: 'Moving to the IV.' },
            { key: 'A', type: 'chord', name: 'pentatonic-minor', title: 'A Minor Pentatonic', description: 'Shift the pattern up to the IV chord root.' },
            { key: 'D', type: 'chord', name: 'perfect-5th', title: 'D5 Power Chord', description: 'The bVII chord for a classic rock sound.' },
            { key: 'E', type: 'chord', name: 'blues', title: 'E Blues Scale', description: 'Add the "blue note" for more attitude.' }
        ],
        'funk-groove': [
            { key: 'E', type: 'chord', name: '9', title: 'E9', description: 'The classic funk chord. Use E Dorian.' },
            { key: 'E', type: 'chord', name: 'dorian', title: 'E Dorian', description: 'Cool and sophisticated minor for funk.' },
        ...
        'neo-soul-flavors': [
            ...
            { key: 'C', type: 'chord', name: 'lydian', title: 'C Lydian', description: 'The #4 adds a beautiful, floaty quality.' },
            { key: 'F', type: 'chord', name: 'maj7', title: 'Fmaj7', description: 'The IV chord. Simple and elegant.' },
            { key: 'F', type: 'chord', name: 'ionian', title: 'F Ionian', description: 'Standard major scale over the IV.' },
            { key: 'E', type: 'chord', name: 'm9', title: 'Em9', description: 'The iii chord. Sophisticated and smooth.' },
            { key: 'E', type: 'chord', name: 'phrygian', title: 'E Phrygian', description: 'The b2 adds a touch of modern tension.' }
        ],
        'folk-acoustic-strummer': [
            ...
            { key: 'G', type: 'chord', name: 'major', title: 'G Major Scale', description: 'The happy, bright foundation.' },
            { key: 'C', type: 'chord', name: 'major-triad', title: 'C Major', description: 'The IV chord. Cheerful and uplifting.' },
            { key: 'G', type: 'chord', name: 'pentatonic-major', title: 'G Major Pentatonic', description: 'A simple, sweet scale for fills.' },
            { key: 'D', type: 'chord', name: 'major-triad', title: 'D Major', description: 'The V chord, leading back home.' },
            { key: 'D', type: 'chord', name: 'mixolydian', title: 'D Mixolydian', description: 'Use the V chord\'s own scale for color.' }
        ],
        'metal-mayhem': [
            { key: 'E', type: 'chord', name: 'perfect-5th', title: 'E5 Power Chord', description: 'Tuned down low. Use E Phrygian or Harmonic Minor.' },
            { key: 'E', type: 'chord', name: 'phrygian', title: 'E Phrygian', description: 'The b2 gives a dark, heavy sound.' },
            { key: 'F', type: 'chord', name: 'tritone', title: 'F Tritone', description: 'The devil\'s interval from the bII chord.' },
            { key: 'E', type: 'chord', name: 'harmonic-minor', title: 'E Harmonic Minor', description: 'Exotic and neoclassical metal flavor.' },
            { key: 'B', type: 'chord', name: 'diminished', title: 'B Diminished', description: 'The v-diminished chord for extreme tension.' },
            { key: 'B', type: 'chord', name: 'phrygian-dominant', title: 'B Phrygian Dominant', description: 'The 5th mode of E Harmonic Minor.' }
        ],
        'bossa-nova-moods': [
            { key: 'C', type: 'chord', name: 'maj7', title: 'Cmaj7', description: 'The I chord. Keep it relaxed with C Ionian.' },
            { key: 'C', type: 'chord', name: 'major', title: 'C Ionian', description: 'Gentle melodies over the tonic.' },
            { key: 'F', type: 'chord', name: 'maj7', title: 'Fmaj7', description: 'The IV chord. Use F Lydian for a brighter sound.' },
            { key: 'F', type: 'chord', name: 'lydian', title: 'F Lydian', description: 'The #11 adds sophistication.' },
        ...
        'country-twang': [
            ...
            { key: 'A', type: 'chord', name: 'pentatonic-major', title: 'A Major Pentatonic', description: 'Perfect for classic country licks.' },
            { key: 'D', type: 'chord', name: 'major-triad', title: 'D Major', description: 'The IV chord. You can stick with A Major Pentatonic or switch.' },
            { key: 'A', type: 'chord', name: 'blues', title: 'A Blues Scale', description: 'Add the b3 for a bluesy country feel.' },
            { key: 'E', type: 'chord', name: 'dom7', title: 'E7', description: 'The V chord. Target the chord tones.' },
            { key: 'E', type: 'chord', name: 'mixolydian', title: 'E Mixolydian', description: 'The perfect scale to outline the V7 sound.' }
        ],
        'ambient-textural': [
            { key: 'D', type: 'chord', name: 'sus2', title: 'Dsus2', description: 'Open and spacious. Use D Ionian or Lydian.' },
            { key: 'D', type: 'chord', name: 'lydian', title: 'D Lydian', description: 'Creates a floating, ethereal texture.' },
            { key: 'G', type: 'chord', name: 'maj7', title: 'Gmaj7', description: 'A warm, gentle chord.' },
            { key: 'G', type: 'chord', name: 'lydian', title: 'G Lydian', description: 'Continue the bright, open sound.' },
            { key: 'A', type: 'chord', name: 'sus4', title: 'Asus4', description: 'A resolving or non-resolving suspension.' },
            { key: 'A', type: 'chord', name: 'mixolydian', title: 'A Mixolydian', description: 'Provides a soft landing or a gentle drive.' }
        ],
        'bebop-language': [
            { key: 'F', type: 'chord', name: 'maj7', title: 'Fmaj7', description: 'The I chord. Use the F Bebop Major scale.' },
            { key: 'F', type: 'chord', name: 'bebop-major', title: 'F Bebop Major', description: 'Adds a passing tone for smooth 8th note lines.' },
            { key: 'C', type: 'chord', name: 'dom7', title: 'C7', description: 'The V chord. Use C Bebop Dominant.' },
            { key: 'C', type: 'chord', name: 'bebop-dominant', title: 'C Bebop Dominant', description: 'The classic scale for V7 chords in bebop.' },
            { key: 'G', type: 'chord', name: 'min7', title: 'Gm7', description: 'The ii chord. Use G Dorian or Bebop Minor.' },
            { key: 'G', type: 'chord', name: 'bebop-minor', title: 'G Bebop Minor', description: 'Adds a passing tone to the dorian mode.' }
        ]
    };
    ...
    function getNoteDisplay(stringIndex, fretNumber, selectedKey, displayType) {
        ...
        switch (displayType) {
            ...
            case 'solfege': {
                ...
                if (keyIndexSol === -1 || noteIndexSol === -1) return '?';
                const intervalSol = (noteIndexSol - keyIndexSol + 12) % 12;
                const SOLFEGE_CHROMATIC = ['Do', 'Di', 'Re', 'Ri', 'Mi', 'Fa', 'Fi', 'Sol', 'Si', 'La', 'Li', 'Ti'];
                // This is a movable Do system starting from the key's root
                const solfegeNames = ['Do', 'Ra', 'Re', 'Me', 'Mi', 'Fa', 'Fi', 'Sol', 'Le', 'La', 'Te', 'Ti'];
                return solfegeNames[intervalSol];
            }
            ...
            default: // 'note-names' (mixed, fallback)
    ...
    // Set initial note colors from dropdown
    ...
    fretboardViewSelect.addEventListener('change', (e) => {
        ...
        } else if (view === 'c-root-one-octave') {
            // High E blank is handled by the initial reset
            setStringFretRange(0, 0, 1); // High E string (index 0): frets 0-1
            setStringFretRange(1, 0, 3); // B string (index 1): frets 0-3
            setStringFretRange(2, 0, 3); // G string (index 2): frets 0-3
            setStringFretRange(3, 0, 4); // D string (index 3): frets 0-4
            setStringFretRange(4, 3, 4); // A string (index 4): frets 3-4
            // Low E string is blank, handled by reset
        } else if (view === 'c-root-two-octave') {
            setStringFretRange(0, 0, 8);   // High E string
            setStringFretRange(1, 0, 4);   // B string
            setStringFretRange(2, 0, 3);   // G string
            setStringFretRange(3, 0, 4);   // D string
            setStringFretRange(4, 0, 4);   // A string
            // Low E string is blank, handled by reset
        } else if (view === 'g-root-two-octave') {
            // High E blank is handled by the initial reset
            setStringFretRange(0, 0, 3);   // High E string (index 0): frets 0-3
            setStringFretRange(1, 0, 4);   // B string (index 1): frets 0-4
            setStringFretRange(2, 0, 3);   // G string (index 2): frets 0-3
            setStringFretRange(3, 0, 4);   // D string (index 3): frets 0-4
            setStringFretRange(4, 0, 4);   // A string (index 4): frets 0-4
            setStringFretRange(5, 3, 4);   // Low E string (index 5): frets 3-4
        } else if (view === 'g-root-one-octave') {
            // High E blank is handled by the initial reset
            // B string blank is handled by the initial reset
            setStringFretRange(2, 0, 0);   // G string
            setStringFretRange(3, 0, 4);   // D string
            setStringFretRange(4, 0, 4);   // A string
            setStringFretRange(5, 3, 4);   // Low E string
        } else if (view === 'a-root-one-octave') {
            // high E, B, low E strings blank handled by reset
            setStringFretRange(4, 0, 4); // A string (index 4)
            setStringFretRange(3, 0, 4); // D string (index 3)
            setStringFretRange(2, 0, 3); // G string (index 2)
        } else if (view === 'a-root-two-octave') {
            setStringFretRange(0, 0, 5);   // High E string
            setStringFretRange(1, 0, 4);   // B string
            setStringFretRange(2, 0, 3);   // G string
            setStringFretRange(3, 0, 4);   // D string
            setStringFretRange(4, 0, 4);   // A string
            // Low E string is blank, handled by reset
        } else if (view === 'd-root-two-octave') {
            // High E blank, handled by reset
            setStringFretRange(1, 0, 3); // B string (index 1)
            setStringFretRange(2, 0, 3); // G string (index 2)
            setStringFretRange(3, 0, 4); // D string (index 3)
            // A and Low E blank, handled by reset
        } else if (view === 'e-root-two-octave') {
            setStringFretRange(0, 0, 0);   // High E string
            setStringFretRange(1, 0, 4);   // B string
            setStringFretRange(2, 0, 3);   // G string
            setStringFretRange(3, 0, 4);   // D string
            setStringFretRange(4, 0, 4);   // A string
            setStringFretRange(5, 3, 6);   // Low E string
        } else if (view === 'g-3-note-per-string') {
            setStringFretRange(0, 7, 15);  // High E string
            setStringFretRange(1, 5, 11);  // B string
            setStringFretRange(2, 4, 8);   // G string
            setStringFretRange(3, 2, 8);   // D string
            setStringFretRange(4, 2, 6);   // A string
            setStringFretRange(5, 3, 6);   // Low E string
    ...
    function updateTuningControls() {
        const fretRangeContentDiv = document.getElementById('fret-range-content');
        if (!fretRangeContentDiv) return; // Guard against missing element
...
C,chord,diminished,C Diminished (W-H) Chord
C,scale,bebop-dominant,C Bebop Dominant Scale
